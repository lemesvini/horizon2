  ...
  return (
    <div className="flex">
      <div className="fixed flex flex-col text-black h-14 laptop:h-[93%] m-2 w-[98%] laptop:m-3 laptop:left-0 bg-white rounded-lg laptop:bottom-4 laptop:w-60 top-14 drop-shadow-md">
        ...
        <div className="hidden laptop:flex laptop:w-[90%] laptop:self-center laptop:rounded-xl laptop:bg-[#9E2A2B] laptop:items-center laptop:h-12 laptop:text-center mb-3">
          <p className="w-full text-white text-xl font-bold bg-[#9E2A2B]">
            Módulo A1-A2
          </p>
        </div>
        <hr className="hidden laptop:flex laptop:w-[90%] self-center" />
        <div className="flex w-full justify-evenly h-fit text-[#0A3153] p-3 text-xl laptop:flex-col laptop:justify-start">
          <button
