    ...
    <div className="flex w-full h-[100%] rounded-lg items-center gap-2 justify-center flex-col ">
      <div className="flex flex-col p-4 border drop-shadow bg-white rounded w-full tablet:w-[60%]">
        ...
        <span className="self-start">
          Como posso descrever minha rotina em inglês?
        </span>
      ...
      <div className="w-full h-[100%] drop-shadow">
        <div className="w-full h-full flex flex-wrap">
          ...
          <div className="bg-white h-[49%] w-full rounded-lg laptop:w-[48%] m-1 flex flex-col justify-evenly">
            {["T-shirt", "Sweater", "Dress", "Skirt", "Shorts"].map(
              (word, index) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <p className="font-extralight">
                    {["Camiseta", "Moletom", "Vestido", "Saia", "Calção"][index]}
                  </p>
                </div>
              )
            )}
          ...
          {/* Second Block */}
          <div className="bg-white h-[49%] w-full rounded-lg laptop:w-[48%] m-1 flex flex-col justify-evenly">
            {["Shoes", "Sneakers", "Flip-flops", "Slippers", "(High) Heels"].map(
              (word, index) => (
                <div
                  key={index}
                  className="w-full flex flex-row justify-between p-2 border-b-2 border-dotted"
                >
                  ...
                  <p className="font-extralight">
                    {
                      ["Sapatos", "Tênis", "Chinelos", "Pantufa", "Salto (alto)"][
                        index
                      ]
                    }
                  </p>
          ...
          {/* Fourth Block */}
          <div className="bg-white h-[49%] w-full rounded-lg laptop:w-[48%] m-1 flex flex-col justify-evenly">
            {["Him", "Her", "It", "to Wear / Wore / Worn"].map((word, index) => (
              <div
                key={index}
                className="w-full flex flex-row justify-between p-2 border-b-2 border-dotted"
              >
                <p className="font-bold">{word}</p>
                <p className="font-extralight">
                  {["Ele", "Ela", "Ele, Ela", "Usar, Vestir"][index]}
                </p>
              </div>
            ))}
          </div>
          ...
          <div className="flex w-full h-fit p-3 flex-col laptop:flex-row gap-3 justify-evenly">
            <div className="flex w-full h-full flex-col">
              ...
              <div className="flex flex-col gap-5 p-4 text-center text-xl">
                <p>
                  "I like <strong className="text-[#9e2a2b]">him</strong> but he doesn't like <strong className="text-[#9e2a2b]">me</strong>."
                </p>
                <p>
                  "She called <strong className="text-[#9e2a2b]">us</strong> yesterday."
                </p>
                <p>
                  "The new student is rude and I don't like <strong className="text-[#9e2a2b]">him</strong>."
                </p>
                <p>
                  "She wears dresses during summer because she likes <strong className="text-[#9e2a2b]">it</strong>."
                </p>
              </div>
            </div>
          </div>
    ...
    <div className="bg-white flex w-full justify-between flex-row h-[100%] rounded-lg drop-shadow">
      <div className="flex flex flex-col w-full p-4 laptop:w-[64%] justify-evenly">
        ...
        <div className="w-full flex flex-col p-3 gap-4 h-fit bg-[#F3F5F7] rounded-xl justify-center pl-4">
          ...
          <p className="tracking-widest p-2">
            Who is a fashion reference in your opinion?
          </p>
        </div>
      </div>
