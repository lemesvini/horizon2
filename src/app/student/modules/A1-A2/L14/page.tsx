  ...
  <div className="w-full h-full p-2">
    <div className="flex w-full h-[100%] rounded-lg items-center gap-2 justify-center flex-col ">
      <div className="flex flex-col p-4 border drop-shadow bg-white rounded w-full tablet:w-[60%]">
        ...
        <br />
        <span className="self-start">Você é bem organizado com dinheiro?</span>
    ...
    <div className="w-full h-[100%] drop-shadow">
      <div className="w-full h-full flex flex-wrap">
        ...
        <div className="bg-white h-[49%] w-full rounded-lg laptop:w-[48%] m-1 flex flex-col justify-evenly">
          {["Store", "Mall", "Salary", "Bill", "Payment"].map((word, index) => (
            <div
              key={index}
            ...
            >
              ...
              <p className="font-extralight">
                {
                  ["Loja", "Shopping", "Salário", "Conta, Nota", "Pagamento"][
                    index
                  ]
                }
              </p>
        ...
        {/* Third Block */}
        <div className="bg-white h-[49%] w-full rounded-lg laptop:w-[48%] m-1 flex flex-col justify-evenly">
          {["Loan", "Wholesale", "Retail", "Income"].map((word, index) => (
            <div
              key={index}
              className="w-full flex flex-row justify-between p-2 border-b-2 border-dotted"
            >
              <p className="font-bold">{word}</p>
              <p className="font-extralight">
                {["Empréstimo", "Atacado", "Varejo", "Renda"][index]}
              </p>
            </div>
          ))}
        </div>
          ...
          <div className=" gap-4 w-full p-3">
            ...
            <div className="w-full justify-center flex flex-col">
              ...
              <p className="w-full p-3 text-center">
                Tag questions must always follow the structure of the first
                sentence:
              </p>
              <div className="flex flex-row justify-around w-full gap-2 text-lg border p-2 rounded mt-2">
                <div className="flex flex-col gap-3 text-xl py-4">
                  <p>
                    He was a doctor,{" "}
                    <strong className="text-[#9E2A2B]">wasn't he?</strong>
                  </p>
                  <p>
                    She was talking to him,{" "}
                    <strong className="text-[#9E2A2B]">wasn't she?</strong>
                  </p>
                  <p>
                    She bought a new car,{" "}
                    <strong className="text-[#9E2A2B]">didn't she?</strong>
                  </p>
                  <p>
                    He didn't buy that house,{" "}
                    <strong className="text-[#9E2A2B]">did he?</strong>
                  </p>
                </div>
                <div className="flex flex-col gap-3 text-xl py-4">
                  <p>
                    Joanna liked that dress,{" "}
                    <strong className="text-[#9E2A2B]">didn't she?</strong>
                  </p>
                  <p>
                    He traveled to the US,{" "}
                    <strong className="text-[#9E2A2B]">didn't he?</strong>
                  </p>
                  <p>
                    Bob spent a lot of money,{" "}
                    <strong className="text-[#9E2A2B]">didn't he?</strong>
                  </p>
                  <p>
                    You can play guitar,{" "}
                    <strong className="text-[#9E2A2B]">can't you?</strong>
                  </p>
                </div>
              </div>
            </div>
