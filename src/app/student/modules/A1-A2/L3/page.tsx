    ...
    <div className="w-full h-[100%] drop-shadow">
      <div className="w-full h-full flex flex-wrap">
        ...
        <div className="bg-white h-[49%] w-full rounded-lg laptop:w-[48%] m-1 flex flex-col justify-evenly">
          {["Routine", "Gym", "Work", "Class", "Chore"].map((word, index) => (
            <div
              key={index}
        ...
        {/* Second Block */}
        <div className="bg-white h-[49%] w-full rounded-lg laptop:w-[48%] m-1 flex flex-col justify-evenly">
          {["House", "Home", "Appointment", "Meeting", "Alarm Clock"].map(
            (word, index) => (
              <div
                key={index}
                className="w-full flex flex-row justify-between p-2 border-b-2 border-dotted"
        ...
        <div className="bg-white h-[49%] w-full rounded-lg laptop:w-[48%] m-1 flex flex-col justify-evenly">
          {[
            ...
            >
              ...
              <p className="font-extralight">
                {
                  ["Acordar", "Escovar os dentes", "Tomar banho", "Assistir"][
                    index
                  ]
                }
              </p>
        ...
        <div className="bg-white h-[49%] w-full rounded-lg laptop:w-[48%] m-1 flex flex-col justify-evenly">
          {[
            ...
            >
              <p className="font-bold">{word}</p>
              <p className="font-extralight">
                {["Tomar café da manhã", "Almoçar", "Jantar", "Dormir"][index]}
              </p>
            </div>
          ))}
        </div>
          ...
          <div className="flex w-full h-fit p-3 flex-col laptop:flex-row gap-3 justify-evenly">
            <div className="flex w-full h-full flex-col">
              ...
              <span className="p-3 bg-[#9E2A2B] w-[80%] self-center text-white flex rounded-xl items-center justify-center text-xl font-bold">
                Talk about routines, recurring events!
              </span>
              <br />
              <div className="flex flex-col gap-5 p-4 text-center text-xl">
                <p>
                  "I <strong className="text-[#9e2a2b]">work</strong> from Monday to Friday."
                </p>
                <p>
                  "I <strong className="text-[#9e2a2b]">get up</strong> at 7 AM and I <strong className="text-[#9e2a2b]">brush</strong> my teeth!"
                </p>
                <p>
                  "I <strong className="text-[#9e2a2b]">drive</strong> to work <strong>everyday</strong>."
                </p>
                <p>
                  "I <strong className="text-[#9e2a2b]">have</strong> English classes twice (2x) a week."
                </p>
              </div>
            </div>
          </div>
